...
function AccordionItem({ className, ...props }: React.ComponentProps<typeof AccordionPrimitive.Item>) {
  return (
    <AccordionPrimitive.Item
      ...
      className={cn("glass-card rounded-2xl border-b-0 px-2", className)}
      {...props}
    />
  );
}
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          "flex flex-1 items-center justify-between gap-4 rounded-md py-5 px-4 text-left text-base font-medium text-white transition-all hover:text-brand-cyan",
