...
type FormState = ContactRequestInput;
    ...
    <form onSubmit={handleSubmit} className="glass-card grid grid-cols-1 gap-5 rounded-2xl p-6 sm:grid-cols-2 sm:p-8">
      <div className="sm:col-span-2">
        ...
        <p className="mt-1 text-sm text-muted">
          Questions about pricing, the process, or anything else? We&apos;d love to hear from you.
        </p>
      </div>
      ...
      <Field label="Business name (optional)" error={errors.businessName}>
        <Input
      ...
      <Field label="Industry (optional)" error={errors.industry}>
        <Select
          value={form.industry ?? ""}
          onChange={(e) => update("industry", (e.target.value || undefined) as FormState["industry"])}
        >
